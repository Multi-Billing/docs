...
Файл расположен по пути ``/var/bill/mbqueue/<version>/config/config.xml``
...
.. code-block:: xml
    ...
    <config>
      <parameters>
        ...
        <debug>false</debug>
        <error_log>/var/bill/logs/mbqueue/mbqueue.log</error_log>
        <debug_log>/var/bill/logs/mbqueue/debug.log</debug_log>
      </parameters>
    </config>
