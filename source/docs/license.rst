...
| После преобретения лицензии, Вам будет выдано 2 файла ``client.key`` и ``serv.crt``, их нужно добавить на сервер где установлен модуль :doc:`mbkernel <install/modules/mbkernel>` в директорию ``/var/bill/license``
| После чего необходимо запустить обновление модуля mbkernel.
